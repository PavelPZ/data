...
export declare const enum IconIds {
    no = 0,
    a = 1,
    b = 2,
    c = 3,
...
export declare const enum CheckItemTexts {
    yesNo = 0,
    trueFalse = 1,
    no = 2,
}
export declare const enum inlineControlTypes {
    no = 0,
    GapFill = 1,
...
export declare const enum offeringDropDownMode {
    dropDownDiscard = 0,
    dropDownKeep = 1,
    gapFillIgnore = 2,
}
export declare type smartOfferingMode = 'GapFill' | 'DropDownDiscard' | 'DropDownKeep' | 'GapFillPassive';
export declare type inlineElementTypes = 'GapFill' | 'GapFillCorrection' | 'DropDown' | 'Img' | 'WordSelection';
export declare type smartElementTypes = 'GapFill' | 'DropDown' | 'Offering' | 'Img' | 'WordSelection';
...
export declare const enum listIcon {
    number = 0,
    letter = 1,
    upperLetter = 2,
    angleDoubleRight = 3,
...
export declare const enum pairingLeftWidth {
    normal = 0,
    small = 1,
    xsmall = 2,
    large = 3,
}
export declare const enum threeStateBool {
    no = 0,
    true = 1,
    false = 2,
}
export declare const enum ExerciseStatus {
    Unknown = 0,
    Normal = 1,
    Preview = 2,
    Evaluated = 3,
...
export declare const enum CourseDataFlag {
    needsEval = 1,
    pcCannotEvaluate = 2,
...
export interface IEvalButtonProps extends ITagProps {
}
